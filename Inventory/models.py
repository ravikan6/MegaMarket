...
class Inventory(models.Model):
    ...
    variant = models.ForeignKey(
        'ItemVariantValue', on_delete=models.CASCADE, null=True, blank=True)
...
class InventoryMovement(models.Model):
    ...
    source = models.CharField(
        max_length=100, null=True, blank=True)  # For transfer type
...
class Item(models.Model):
    ...
    image = models.ForeignKey(
        'Common.Image', on_delete=models.CASCADE, null=True, blank=True)
    media = models.ManyToManyField(
        'Common.ItemMedia', related_name='media', through='ItemMediaThrough')
    ...
    category = models.ForeignKey(
        'Category', on_delete=models.CASCADE, null=True, blank=True, related_name="items")
    vendor = models.ForeignKey(
        'Vendor.Vendor', on_delete=models.CASCADE, related_name="items")
    brand = models.ForeignKey(
        'Admin.Brand', on_delete=models.CASCADE, null=True, blank=True, related_name="items")
...
class ItemMediaThrough(models.Model):
    ...
    item_media = models.ForeignKey(
        'Common.ItemMedia', on_delete=models.CASCADE)
...
class ItemVariantValue(models.Model):
    ...
    item = models.ForeignKey('Item', on_delete=models.CASCADE)
    variant = models.ForeignKey(
        'ItemVariation', on_delete=models.CASCADE, related_name='values')
...
class ItemReview(models.Model):
    ...
    variant = models.ForeignKey('ItemVariation', on_delete=models.CASCADE,
                                null=True, blank=True, related_query_name="reviews")
    user = models.ForeignKey(
        'User.User', on_delete=models.CASCADE, related_name="item_reviews")
...
class Order(models.Model):
    ...
    shipping_address = models.ForeignKey(
        'User.Address', on_delete=models.CASCADE, related_name='shipping_address')
    billing_address = models.ForeignKey(
        'User.Address', on_delete=models.CASCADE, related_name='billing_address')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class PromoCode(models.Model):
    ...
    used_by = models.ManyToManyField(
        'User.User', related_name='promo_codes', through='PromoCodeUsage')
